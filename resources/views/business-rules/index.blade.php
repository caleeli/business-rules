    ...
    <div class="container page-content" id="app-business-rules" v-cloak>
        ...
        <b-modal id="sample-modal"
            ...
            <div class="form-group">
                ...
                {!!Form::text('variable', null, ['class'=> 'form-control', 'v-model'=> 'sample.variable', 'v-bind:class'
            ...
            <div class="form-group">
                ...
                {!!Form::text('condition', null, ['class'=> 'form-control', 'v-model'=> 'sample.condition', 'v-bind:class'
